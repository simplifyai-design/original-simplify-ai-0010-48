...
const HeroSection = () => {
  return (
    <main
      ...
      className="text-center z-20 bg-[#000a0e]/50 px-4 py-[7px] my-[6px]"
    >
      ...
      <p className="max-w-3xl mx-auto text-base sm:text-lg md:text-xl text-slate-300 mb-8 px-2">
      ...
      <div className="flex flex-col sm:flex-row justify-center gap-4 sm:space-x-4 px-4">
        <Button
          className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg transition-transform hover:scale-105 w-full sm:w-auto"
          asChild
        >
          <a href="#contact">Book a Free Strategy Call</a>
        </Button>
        <Button
          className="bg-slate-700 hover:bg-slate-600 text-white font-bold py-3 px-6 rounded-lg transition-transform hover:scale-105 w-full sm:w-auto"
          asChild
        >
