      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-gray-900 rounded-lg p-8 border-2 border-transparent hover:border-purple-800 transition-colors bg-slate-700">
            ...
            <p className="text-4xl font-bold text-blue-200">$125/hour</p>
          ...
          <div className="border-2 border-purple-800 text-white rounded-lg p-8 relative bg-slate-800">
          ...
          <div className="text-white rounded-lg p-8 border-2 border-transparent hover:border-purple-800 transition-colors bg-slate-900">
