...
const QuotesCarousel = () => {
  ...
  return <div className="w-full mt-8 min-h-[100px] flex items-center justify-center py-[4px] my-[8px]">
      <div className={`text-white/90 font-playfair text-lg md:text-xl italic text-center px-8 transition-all duration-500 ${isVisible ? 'opacity-100 transform translate-x-0' : 'opacity-0 transform translate-x-8'}`} style={{
