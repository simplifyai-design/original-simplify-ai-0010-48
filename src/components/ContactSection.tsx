...
const ContactSection = () => {
  ...
  return <section id="contact" className="py-20 px-6 relative z-10 bg-slate-900">
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-4xl lg:text-5xl font-bold text-white mb-6">Get Started Today</h2>
          <p className="text-xl text-blue-700">Ready to transform your business with AI automation?</p>
        </div>
        ...
        <Card className="shadow-xl border-gray-500 bg-gray-800/50 backdrop-blur-sm border-orange-500/30">
          <CardContent className="p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button type="submit" size="lg" className="w-full text-lg py-6 text-white bg-green-600 hover:bg-green-500">
